...
def seq2seq_model(inputs, targets, keep_prob, batch_size, sequence_length, answers_num_words, questions_num_words, encoder_embedding_size, decoder_embeddings_size, rnn_size, num_layers, questionswords2int):
    ...
    decoder_embedded_input = tf.nn.embedding_input(decoder_embeddings_matrix, preprocessed_targets)
